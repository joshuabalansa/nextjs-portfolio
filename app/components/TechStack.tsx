...
const TechStack = () => {
  return (
    <section className="grid place-content-center gap-2 px-8 py-24 dark:text-white light:text-black mb-72">
      ...
      <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 mb-14 text-center">As a Full Stack Developer, I specialize in creating dynamic, robust, and user-friendly applications using modern technologies.</p>
